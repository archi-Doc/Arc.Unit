...
public interface IUnitExecutable : IRadioService
{
    ...
    /// This method is called after <see cref="IUnitSerializable.Load(UnitMessage.Load, CancellationToken)"/> and may be called once or multiple times.<br/>
    /// </summary>
    /// <param name="message">Unit message.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    public Task Start(UnitMessage.Start message, CancellationToken cancellationToken);

    /// <summary>
    /// Performs the suspension process for unit objects.<br/>
    /// This method is called after <see cref="IUnitExecutable.Start(UnitMessage.Start, CancellationToken)"/>.
    /// </summary>
    /// <param name="message">Unit message.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    public Task Terminate(UnitMessage.Terminate message, CancellationToken cancellationToken);
}
