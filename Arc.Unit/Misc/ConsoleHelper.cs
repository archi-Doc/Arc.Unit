...
public static class ConsoleHelper
{
    ...
    public static ReadOnlySpan<char> EraseLineSpan => "\u001b[K";

    public static ReadOnlySpan<char> EraseLine2Span => "\u001b[2K";

    public static ReadOnlySpan<char> ResetSpan => "\u001b[0m";

    public static ReadOnlySpan<char> SaveCursorSpan => "\x1b[s";

    public static ReadOnlySpan<char> RestoreCursorSpan => "\x1b[u";

    public static ReadOnlySpan<char> HideCursorSpan => "\x1b[?25l";
